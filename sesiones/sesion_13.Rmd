...
Por lo tanto, si $X$ es el conjunto de datos original, $Y$ es el conjunto de datos transformado (ambos con el tamaño $m \times n$) y $P$ es la transformación lineal ($ m \times m $)
$$
PX = Y,
$$

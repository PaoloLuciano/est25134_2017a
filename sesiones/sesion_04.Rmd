...
# Ejemplo 1: Datos similados separados
...
Respecto a la media de los coeficientes de proyeccion, se obtienen los siguientes resultados.
```{r ex1_summary}
# Kernel Density Plot
...
dde <- read.csv('SSVS_Probit_Data.csv', 
                header = TRUE, sep = ",", 
                quote="\"", dec=".", fill = TRUE)
